...
def slider_value(values):
    surfaceExtractor.SetValue(0, values)
...
class AppWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.iso_slider.valueChanged.connect(slider_value)
        self.ui.opacity_slider.valueChanged.connect(self.Ray_casting)
        self.ui.add_data_button.clicked.connect(self.load_data)
    ...
    def select(self):
        if (self.ui.comboBox.currentText() == "Srenderingurface "):
            self.Surface()
    ...
    def Ray_casting(self):
        ...
        volumeGradientOpacity.AddPoint(
            90, self.ui.opacity_slider.value()/100)
    ...
    def Surface(self):
        ...
        self.aRenderer.SetBackground(1, 1, 1)
